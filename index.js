...
setupDashboard(app, {
  sessions, workers, paymentLedger, ratingsLog, auditLog,
  knowledgeBase, pinLockout, jobArchive,
  findByLast4, displayPhone, last4, toWaId,
  processPayment, sendMsg, alertOwner, clearTimers,
  calcBill, getSession, addFile, PRICES, audit, nowStr, todayStr,
  buildReceiptHTML,
  get botActive()  { return botActive;  },
  set botActive(v) { botActive = v;     },
  get botCrashed() { return botCrashed; },
  set botCrashed(v){ botCrashed = v;    },
  get ADMIN_PIN()  { return ADMIN_PIN;  },
  get ADMIN_DASHBOARD_PASSWORD() { return ADMIN_DASH_PW; },
});
